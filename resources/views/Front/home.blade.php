    ...
    <footer>
        <div class="container">
            <div class="footer-logo">
                <h1 class="logo">
                    <img src="Image/Logo.png" alt="footer-logo"></h1>
            </div>
            <div class="footer-links">
                <div>
                    <h4>Top Category</h4>
                    <ul>
                        <li><a href="courses.html" class="text-white">Design</a></li>
                        <li><a href="courses.html" class="text-white">Development</a></li>
                        <li><a href="courses.html" class="text-white">Marketing</a></li>
                        <li><a href="courses.html" class="text-white">Business</a></li>
                    </ul>
                </div>
                <div>
                    <h4>Quick Links</h4>
                    <ul>
                        ...
                        <li><a href="ContactUs.html" class="text-white">Support</a></li>
                    </ul>
                </div>
            </div>
